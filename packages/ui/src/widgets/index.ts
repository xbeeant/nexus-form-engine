...
export const antdWidgets: Record<string, (props: WidgetProps) => ReactNode> = {
  ...
  dateString: datePickerWidget, // 日期选择器（字符串传输格式，x-render 对齐）
  dateRange: dateRangeWidget, // 日期范围选择器
  dateRangePicker: dateRangeWidget, // 日期范围选择器
  dateRangeString: dateRangeWidget, // 日期范围选择器（字符串传输格式，x-render 对齐）
  time: timePickerWidget, // 时间选择器
  timePicker: timePickerWidget, // 时间选择器
  timeString: timePickerWidget, // 时间选择器（字符串传输格式，x-render 对齐）
  timeRange: timeRangeWidget, // 时间范围选择器
  timeRangePicker: timeRangeWidget, // 时间范围选择器
  timeRangeString: timeRangeWidget, // 时间范围选择器（字符串传输格式，x-render 对齐）
